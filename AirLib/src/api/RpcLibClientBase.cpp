...
msr::airlib::Twist RpcLibClientBase::simGetObjectTwist(const std::string& object_name) const
{
    return pimpl_->client.call("simGetObjectTwist", object_name).as<RpcLibAdapatorsBase::Twist>().to();
}
